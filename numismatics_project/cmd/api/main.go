...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("NUMISMATICS_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "26677a940315bc", "SMTP username")
